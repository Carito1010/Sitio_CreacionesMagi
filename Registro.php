    ...
    <section id="registro">
        <div class="container">
            <form>
                ...
                <div class="mb-3">
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Dirección">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Confirma la contraseña">
                </div>
                <p>La información proporcionada no se expondra!</p>
